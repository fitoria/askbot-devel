...
TYPE_ACTIVITY_CREATE_SPACE_DESCRIPTION = 31
TYPE_ACTIVITY_EDIT_SPACE_DESCRIPTION = 32
...
TYPE_ACTIVITY = (
    ...
    (
        TYPE_ACTIVITY_CREATE_SPACE_DESCRIPTION,
        _('created a space description')
    ),
    (
        TYPE_ACTIVITY_EDIT_SPACE_DESCRIPTION,
        _('edited a space description')
    ),
)
