...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('askbot_space', (
            ...
            ('description', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Post'])),
        ))
    ...
    models = {
        ...
        'askbot.space': {
            ...
            'description': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['askbot.Post']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
